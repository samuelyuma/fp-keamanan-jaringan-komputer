...
| A5          | Lantai7 > Switch2 > 702 > Switch2 > 703 > Switch2 > 704 Switch2 > 705 | 121       | /25     |
| A6          | TW2 > Lantai9 > Switch3 > LabSOC > Switch3 > LabKCKS                  | 181       | /24     |

### Pembagian IP

| Subnet | Network ID    | Netmask         | Broadcast     | Range IP                      |
| ------ | ------------- | --------------- | ------------- | ----------------------------- |
| A1     | 192.168.0.208 | 255.255.255.252 | 192.168.0.211 | 192.168.0.209 - 192.168.0.210 |
| A2     | 192.168.0.204 | 255.255.255.252 | 192.168.0.207 | 192.168.0.205 - 192.168.0.206 |
| A3     | 192.168.0.200 | 255.255.255.252 | 192.168.0.203 | 192.168.0.201 - 192.168.0.202 |
| A4     | 192.168.0.192 | 255.255.255.248 | 192.168.0.199 | 192.168.0.193 - 192.168.0.198 |
| A5     | 192.168.0.0   | 255.255.255.128 | 192.168.0.127 | 192.168.0.1 - 192.168.0.126   |
| A6     | 192.168.0.128 | 255.255.255.192 | 192.168.0.191 | 192.168.0.129 - 192.168.0.190 |
